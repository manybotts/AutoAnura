...
BOT_TOKEN = environ.get('BOT_TOKEN', '5287030714:AAFOT1fhqmDQpJCA0TCiioac3l3U50M1dlA')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001567908315', '-1001668227511' '-1001326392643').split()]
