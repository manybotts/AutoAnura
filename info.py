...
API_ID = int(environ.get('API_ID', '5166878'))
API_HASH = environ.get('API_HASH', 'fdafb41f9a67f40e34a6c67f47730a92')
BOT_TOKEN = environ.get('BOT_TOKEN', '5586451503:AAGeS7jtmtUt6VGOhJ2OO603QRcEZWfWGf8')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1878420867').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001841281459').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1001794572180')
...
DATABASE_NAME = environ.get('DATABASE_NAME', "seriesbott1")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Hd10tv1')
